class PhonStateKTT:
    def __init__(self, options={}, pos=None, endOfSentence=False):
        ...
        self.joiningChar = options['joiningChar'] if 'joiningChar' in options else ' '
